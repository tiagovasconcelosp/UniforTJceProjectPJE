...
class TaskCitacaoIntimacaoSentenca_PJE_027:
    ...
    def prepDestinatario(self,driver,logging,metodos):
        ...
        for linha in linhas:
            ...
            metodos.selecionar_option_select(selects, "Intimação da Sentença", identico=True)
            time.sleep(2)
            # Selecionar Meio
    ...
    def prepAto(self,driver,logging,metodos):
        ...
        while npagina_incrementada <= totalpaginas:
            ...
            for linha in linhas2:
                ...
                if sentenca in colunas_elemento:
    ...
    def Execute(self, driver, logging, url, dataform, acaoEmErro, xml):
        ...
        while repete:
            ...
            try:
                ...
                etiqueta = [i.text for i in xml.iter('etiquetaCitacaoIntimacaoSentenca')][0]    
                outra_tentativa  = True
                while outra_tentativa:
                    try:
