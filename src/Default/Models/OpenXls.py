...
class OpenXls:
    ...
    def OpenFileXls(self, driver, logging):
    ...
    def getDataProcessAguardandoSessaoXLS(self, data, driver, logging, xml):
    ...
    def getDataProcessInclusaoXLS(self, data, driver, logging, xml):
    ...
    def getDataProcessTrasitarJulgadoXLS(self, data, driver, logging, xml):
    ...
    def getDataProcessLancamentoXLS(self, data, driver, logging, xml):
